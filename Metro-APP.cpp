...
map<string,int>mp; // Key -> name of the station & Value -> station number(node number) 
map<int,string>i2s; // Key -> station number(node number) & Value -> name of the station
int sz; // Total number of metro stations
vector<string>keys; //It stores the name of the metro station
